...
public class VipInfoImplTest {
	...
	public void setUp() throws Exception {
		...
		// this.userDAO1 = new UserDAOImpl_Stub(userIDr, passwordr, telNumr,
		// creditValuer, creditRecord, birth, vipRank);
		// this.userDAO2 = new UserDAOImpl_Stub(userIDe, passworde, telNume,
		// creditValuee, creditRecord, enterpriseID,
		// enterprisePassword);
	}
	...
	public void testGetRegularVipInfo() {
		...
		try {
			...
			// assertEquals("VipInfo.getRegularVipInfo(userID) has an error in
	...
	public void testGetEnterpriseVipInfo() {
		...
		try {
			...
			// assertEquals("VipInfo.getEnterpriseVipInfo(userID) has an error
			// in creditRecord!", creditRecord,

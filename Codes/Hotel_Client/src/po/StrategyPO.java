...
public class StrategyPO {
    ...
    public StrategyPO(Enum<StrategyType> strategyType){
        if(strategyType.equals(StrategyType.BirthdayPromotion))
            this.strategyType=strategyType;
    }
    
    public StrategyPO(Enum<StrategyType> strategyType, int inputInt){
        this.strategyType=strategyType;
    ...
    public StrategyPO(Enum<StrategyType> strategyType, String enterpriseName, String securityCode){
        this.strategyType=strategyType;
        this.enterpriseName=enterpriseName;
        this.securityCode=securityCode;
    }
    
    public StrategyPO(Enum<StrategyType> strategyType, Date startTime, Date endTime){
        this.strategyType=strategyType;
        this.startTime=startTime;
        this.endTime=endTime;
    }
    
    public StrategyPO(Enum<StrategyType> strategyType, int vipRank, String tradeArea){
        this.strategyType=strategyType;
